...

''')
...
class Tls():
    ...
    def handle_alert_message(self, pkt):
        if len(pkt) != 2:
            raise Exception('Invalid alert message length')
        alert_level, alert_description = pkt
        self.trace('TLS Alert: level=%d, description=%d' % (alert_level, alert_description))
